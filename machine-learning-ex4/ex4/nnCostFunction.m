...
J = J + (sum(sum(Theta1NoBias.^2)) + sum(sum(Theta2NoBias.^2)))*(lambda/(2*m));
...
Theta1_grad = (1 / m) * Theta1_grad + (lambda / m) * Theta1ZeroBias;
Theta2_grad = (1 / m) * Theta2_grad + (lambda / m) * Theta2ZeroBias;
